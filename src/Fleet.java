...
public class Fleet {
    ...
    // AI disclosure - I could not figure out how to get the initial placement of the fleet to work.
    // Google Gemini suggested creating the attemptPlacement method from the original placeFleet, and
    // the placement code was generated by Gemini. Sorry I couldn't figure out this on my own!
